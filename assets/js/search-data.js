...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
    ...
    },{id: "projects-the-butterfly-vitals-untethered",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%72%65%69%6E%61%6C%64%6F@%67%61%74%65%63%68.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Reinald0-M", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/reinaldo-mock", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=QIeV83oAAAAJ&hl", "_blank");
        },
      },{
      id: 'light-theme',
